...
import static com.cyut.motor.s065.WarrantyActivity.key_array;

public class WTableAdapter extends BaseAdapter {
    ...
    public WTableAdapter(Context context, ArrayList<TableRow> table) {
